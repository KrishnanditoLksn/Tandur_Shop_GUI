 ...
 * @author ASUS
 */
public class TanamanWijayaKusuma extends Tanaman {

    public TanamanWijayaKusuma() {

    }

    public TanamanWijayaKusuma(String namaTanaman, int hargaTanaman, int stokTanaman) {
